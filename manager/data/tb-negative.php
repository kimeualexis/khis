<!DOCTYPE html>
<html ng-app="tbnegative">
<head>
	<title>TB Negative</title>
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-10" ng-init="tb_neg()">
<h3 class="page-header text-center text-primary"><strong>Tuberculosis</strong></h3>
			<a href="#" class="btn btn-default">2015</a>
			<a href="#" class="btn btn-default">2016</a>
			<a href="../2017/tb-tested.php" class="btn btn-default">2017</a>
			<a href="tb-tested.php" class="btn btn-default">2018</a>
			<br>
			<br>
			<br>
...
<script src="js/tbnegative.js"></script>
</body>
</html>
