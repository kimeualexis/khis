<!DOCTYPE html>
<html ng-app="cholerapositive">
<head>
	<title>Cholera Positive</title>
	<meta charset="utf-8">
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-10" ng-init="cholera_pos()">
<h3 class="page-header text-center text-primary"><strong>Cholera</strong></h3>
			...
			<a href="cholera-tested.php" class="btn btn-default">2017</a>
			<a href="../data/cholera-tested.php" class="btn btn-default">2018</a>
			<br>
			<br>
			<br>
...
<script src="js/cholerapositive.js"></script>
</body>
</html>
