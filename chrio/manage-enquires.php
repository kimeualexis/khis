...
{				?>
						  <tr>
							...
							<td width="120"><?php echo htmlentities($result->FirstName);?></td>
							<td width="120"><?php echo htmlentities($result->LastName);?></td>
							<td width="50"><?php echo htmlentities($result->Phone);?> </td><br />
							<td width="120"><?php echo htmlentities($result->Email);?></td>
